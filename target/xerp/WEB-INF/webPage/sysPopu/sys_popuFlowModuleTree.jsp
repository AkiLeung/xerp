...
<head>
    ...
    <script type="text/javascript">
        ...
        function initZTree() {
            $.ajax({
                url: "<%=basePath %>sysConfig/flowModule/getZTree.action",
                type: "post",
                dataType: "json",
...
<form id="form1">
        ...
        selectValue:<input type="text" id="selectValue" name="selectValue" style="width: 200px"/><br>
        fieldCode:<input type="text" value="<%=request.getParameter("code")%>" id="fieldCode" name="fieldCode"><br>
