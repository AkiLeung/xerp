    ...
    <table class="tbl" style="width:100%; height:200px" border="1">
        <tr style="display:none">
            ...
            <td class="tblCell">
                ...
                <input value="<%=request.getParameter("uuid")%>" name="typeCode" type="text" id="typeCode"/>
            </td>
        </tr>
        <tr>
...
<script type="text/javascript">
    ...
    function saveData() {
        //保存前檢查
        if ($("#keyCode").val() == "") {
            $.messager.alert('Field Required', 'Key code must be entered!');
            return false;
        }
        if ($("#keyName").val() == "") {
            $.messager.alert('Field Required', 'Key name must be entered!');
            return false;
        }
        //執行保存
        var objData = {
